...
# containerDisks inject the nvmetcli tools into the base cloud image with
# virt-customize on the host (scripts/build-containerdisk.sh), then package the
# resulting qcow2 as a scratch containerDisk.
