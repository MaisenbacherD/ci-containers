...
def main():
    ...
    # Query modes used by the containerDisk build (scripts/build-containerdisk.sh):
    # virt-customize runs on the host, so the package list and base image are
    # consumed outside the Dockerfile.
